...
/**
 * Base class that represents a row from the 'castle_2_attack' table.
 *
 *
 *
 * @package    propel.generator.orm.om
 */
abstract class BaseCastle2Attack extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Castle2AttackPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        Castle2AttackPeer
     */
    ...
    public function setCastleId($v)
    {
        ...
        if ($this->castle_id !== $v) {
            $this->castle_id = $v;
            $this->modifiedColumns[] = Castle2AttackPeer::CASTLE_ID;
        }
    ...
    public function setAttackId($v)
    {
        ...
        if ($this->attack_id !== $v) {
            $this->attack_id = $v;
            $this->modifiedColumns[] = Castle2AttackPeer::ATTACK_ID;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = Castle2AttackPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = Castle2AttackQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                Castle2AttackPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `castle_2_attack` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = Castle2AttackPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = Castle2AttackPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
     ...
     * objects.
     *
     * @param object $copyObj An object of Castle2Attack (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Castle2Attack Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return Castle2AttackPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new Castle2AttackPeer();
        }
    ...
    public function getAttack(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAttack === null && ($this->attack_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAttack->addCastle2Attacks($this);
             */
        }
    ...
    public function getCastle(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCastle === null && ($this->castle_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCastle->addCastle2Attacks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(Castle2AttackPeer::DEFAULT_STRING_FORMAT);
    }

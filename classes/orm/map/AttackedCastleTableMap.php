...
/**
 * This class defines the structure of the 'attacked_castle' table.
 *
 *
 *
 ...
 */
class AttackedCastleTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'orm.map.AttackedCastleTableMap';
    ...
    {
        // attributes
        $this->setName('attacked_castle');
        $this->setPhpName('AttackedCastle');
        $this->setClassname('AttackedCastle');
        $this->setPackage('orm');
